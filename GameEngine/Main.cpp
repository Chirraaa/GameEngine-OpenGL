...
int main() {
	...
	GLFWwindow* window = glfwCreateWindow(WINDOW_HEIGHT, WINDOW_WIDTH, "OpenGL Adam", NULL, NULL);
	if (window == NULL) {
	...
	*/
	...
	projection = glm::perspective(glm::radians(fov), (float)WINDOW_HEIGHT / (float)WINDOW_WIDTH, 0.1f, 100.0f);
